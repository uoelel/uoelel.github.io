...
[Best practices](https://help.osf.io/article/147-organizing-files) for researchers compiled by the Open Science Foundation. From file management to publishing research output.
...
Quarto is the [official successor of Rmarkdown](https://quarto.org/docs/faq/rmarkdown.html) and it is heavily based on Rmarkdown. In fact, Quarto is 100% backward compatible with Rmarkdown. Rmarkdown will not go away!
:::
