...
```{=html}
<a class="btn btn-primary" href="https://outlook.office365.com/owa/calendar/Stefanosofficehours@uoe.onmicrosoft.com/bookings/s/CYTtarS6AUSqGdZi5dzBzw2" role="button">Book with Stefano</a>

<a class="btn btn-primary" href="https://outlook.office.com/bookwithme/user/49afe80a7e344adb8ff5770868f0729d@sms.ed.ac.uk?anonymous&ep=pcard" role="button">Book with Elizabeth</a>
```
...
```{=html}
<a class="btn btn-primary" href="https://outlook.office365.com/owa/calendar/Stefanosofficehours@uoe.onmicrosoft.com/bookings/s/CYTtarS6AUSqGdZi5dzBzw2" role="button">Book an appointment</a>
<br><br>
```
