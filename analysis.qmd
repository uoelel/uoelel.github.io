...
For an excellent tutorial on how to fit ordinal linear models using brms applied to linguistics data, see @verissimo2021. You should also check out the more general tutorial @burkner2019. A recording of the [STeW](stew.qmd) workshop on ordinal regression model is also available [here](here).
...
-   Another excellent resource is @pedersen2019. In particular, [Figure 4](https://doi.org/10.7717/peerj.6876/fig-4) is a beautiful visual summary of how different types of trends and groupings can be modelled with GAMs.
